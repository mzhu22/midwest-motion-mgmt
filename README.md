...
Go to the latest release from https://github.com/mzhu22/midwest-motion-mgmt/releases. Download `MidwestMotionMgmt-windows.zip`, unzip, and run the executable.

Follow the instructions in the contouring app.
